/*
((Line 4987)) PATCH Set the displacment between each node instead of 
calculating it according to tree size
*/
...
d3 = function() {
  ...
  d3.layout.tree = function() {
    ...
    function tree(d, i) {
      ...
      d3_layout_treeVisitAfter(root, function(node) {
        node.x = (node.x - x0) / (x1 - x0) * size[0];
        // PATCH Set the displacment between each node instead of 
        // calculating it according to tree size.
        // Originally @ [line: 4976] node.y = node.depth / y1 * size[1];
    ...
    tree.depth = function(root) {
      return d3_layout_treeSearch(root, d3_layout_treeDeepest).depth;
    };
